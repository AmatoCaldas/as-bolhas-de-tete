...
@onready var grid: Node2D = $Grid  # Referência ao TileMap
@onready var tilemap: TileMap = $Grid/TileMap  # Referência ao TileMap
@onready var personagem: Node2D = $Grid/Tete  # Referência ao personagem
@onready var enemy: Node2D = $Grid/Enemy # Referência ao inimigo
